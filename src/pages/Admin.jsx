...
export default function Admin() {
  ...
  const handleSubmit = () => {
    const request = isUpdating
      ? axios.put("http://18.208.224.218:8082/update", formData)
      : axios.post("http://18.208.224.218:8082/insert", formData);
  ...
  const handleDelete = (rid) => {
    if (window.confirm("Are you sure you want to delete this recipe?")) {
      axios
        .delete(`http://18.208.224.218:8082/delete`, { params: { rid } })
        .then((res) => {
          alert(res.data);
          fetchRecipes();
        })
